...
public class RegExpValidatorUtils {
    ...
    public static boolean checkTelephone(String telephone) {
        ...
        return match(landlinePhoneRegexp, telephone);
    }
...
//        String regex = "^((((1[6-9]|[2-9]\\d)\\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\\d|3[01]))|(((1[6-9]|[2-9]\\d)\\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\\d|30))|(((1[6-9]|[2-9]\\d)\\d{2})-0?2-(0?[1-9]|1\\d|2[0-8]))|(((1[6-9]|[2-9]\\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-)) (20|21|22|23|[0-1]?\\d):[0-5]?\\d:[0-5]?\\d$";
     ...
     * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean Is20Letter(String str) {
        String regex = "/^.{0,20}$/";
        return match(regex, str);
    }
     ...
     *
     *
     * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>[-+]{0,1}\\d+\\.\\d*|[-+]{0,1}\\d*\\.\\d+
     */
     ...
     * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean IsLengthAndNumber(String str) {
     ...
     * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean IsLengthOrNumber(String str) {
	 ...
	 * 计算字符串长度
	 * @param str
	 * @return 返回字符串长度，中文按照2个字符算
	 */
	public static int strLengthWithChinese4Two(String str) {
		int count = 0;
		int chineseNum = 0;
		String regex = "[\u4e00-\u9fa5]";
		...
		count = str.length() - chineseNum + chineseNum * 2;
		return count;
	}
